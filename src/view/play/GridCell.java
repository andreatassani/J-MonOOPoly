...
public class GridCell extends JPanel {
	...
	public GridCell() {
		...
		north.add(new Cell(0, "Via!", Color.WHITE));
		north.add(new PropertyCell((Property) deck.get(0)));
		north.add(new Cell(2, "Probabilità", Color.WHITE));
		north.add(new PropertyCell((Property) deck.get(1)));
		north.add(new Cell(4, "Tassa", Color.WHITE));
		north.add(new Cell(5, "stazione N", Color.GRAY));
		north.add(new PropertyCell((Property) deck.get(2)));
		north.add(new Cell(7, "Imprevisto", Color.WHITE));
		north.add(new PropertyCell((Property) deck.get(3)));
		north.add(new PropertyCell((Property) deck.get(4)));
		north.add(new Cell(10,"Prigione", Color.WHITE));
		...
		south.add(new Cell(20, "Parcheggio", Color.WHITE));
		west.add(new PropertyCell((Property) deck.get(21)));
		west.add(new PropertyCell((Property) deck.get(20)));
		west.add(new Cell(33, "probabilità", Color.WHITE));
		west.add(new PropertyCell((Property) deck.get(19)));
		west.add(new Cell(35, "stazione O", Color.GRAY));
		west.add(new Cell(36, "Imprevisto", Color.WHITE));
		west.add(new PropertyCell((Property) deck.get(18)));
		west.add(new Cell(38, "Tassa", Color.WHITE));
