...
public class GridCell extends JPanel {
	...
	public GridCell() {
		...
		north.add(new Cell(1, "Forlì", new Color(204, 102, 0), Optional.of("res/cittàMARRONE.png")));
		north.add(new Cell(2, "probabilità", Color.WHITE, Optional.of("res/probabilità.png")));
		north.add(new Cell(3, "Cesena", new Color(204, 102, 0), Optional.of("res/cittàMARRONE.png")));
		...
		north.add(new Cell(6, "Parma", Color.CYAN, Optional.of("res/cittàAZZURRA.png")));
		north.add(new Cell(7, "imprevisto", Color.WHITE, Optional.of("res/imprevisto.png")));
		north.add(new Cell(8, "Teramo", Color.CYAN, Optional.of("res/cittàAZZURRA.png")));
		north.add(new Cell(9, "Cuneo", Color.CYAN, Optional.of("res/cittàAZZURRA.png")));
		north.add(new Cell(10,"prigione", Color.WHITE, Optional.of("res/prigioniero.png")));
		east.add(new Cell(11, "Catania", Color.MAGENTA, Optional.of("res/cittàFUCSIA.png")));
		east.add(new Cell(12, "enel", Color.WHITE, Optional.of("res/lampadina.png")));
		east.add(new Cell(13, "Bologna", Color.MAGENTA, Optional.of("res/cittàFUCSIA.png")));
		east.add(new Cell(14, "Verona", Color.MAGENTA, Optional.of("res/cittàFUCSIA.png")));
		east.add(new Cell(15, "stazione E", Color.WHITE, Optional.of("res/treno.png")));
		east.add(new Cell(16, "Siena", new Color(255, 137, 0), Optional.of("res/cittàARANCIONE.png")));
		east.add(new Cell(17, "probabilità", Color.WHITE, Optional.of("res/probabilità.png")));
		east.add(new Cell(18, "Messina", new Color(255, 137, 0), Optional.of("res/cittàARANCIONE.png")));
		east.add(new Cell(19, "Foggia", new Color(255, 137, 0), Optional.of("res/cittàARANCIONE.png")));
		south.add(new Cell(30, "polizia", Color.WHITE, Optional.of("res/poliziotto.png")));
		south.add(new Cell(29, "Rieti", Color.YELLOW, Optional.of("res/cittàGIALLA.png")));
		south.add(new Cell(28, "hera", Color.WHITE, Optional.of("res/acqua.png")));
		south.add(new Cell(27, "Rimini", Color.YELLOW, Optional.of("res/cittàGIALLA.png")));
		south.add(new Cell(26, "Caserta", Color.YELLOW, Optional.of("res/cittàGIALLA.png")));
		south.add(new Cell(25, "stazione S", Color.WHITE, Optional.of("res/treno.png")));
		south.add(new Cell(24, "Cagliari", Color.RED, Optional.of("res/cittàROSSA.png")));
		south.add(new Cell(23, "Bari", Color.RED, Optional.of("res/cittàROSSA.png")));
		south.add(new Cell(22, "imprevisto", Color.WHITE, Optional.of("res/imprevisto.png")));
		south.add(new Cell(21, "Salerno", Color.RED, Optional.of("res/cittàROSSA.png")));
		south.add(new Cell(20, "parcheggio", Color.WHITE, Optional.of("res/parcheggio.png")));
		west.add(new Cell(39, "Milano", Color.BLUE, Optional.of("res/cittàBLU.png")));
		west.add(new Cell(38, "tassa", Color.WHITE, Optional.of("res/soldi.png")));
		west.add(new Cell(37, "Roma", Color.BLUE, Optional.of("res/cittàBLU.png")));
		...
		west.add(new Cell(34, "Bologna", Color.GREEN, Optional.of("res/cittàVERDE.png")));
		west.add(new Cell(33, "probabilità", Color.WHITE, Optional.of("res/probabilità.png")));
		west.add(new Cell(32, "Aosta", Color.GREEN, Optional.of("res/cittàVERDE.png")));
		west.add(new Cell(31, "Trento", Color.GREEN, Optional.of("res/cittàVERDE.png")));
